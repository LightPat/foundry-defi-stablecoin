 ...
 *
 * @notice This contract is the core of the DSC System. It handles all the logic for the mining and redeeming DSC, as well as depositing & withdrawing collateral.
...
contract DSCEngine is ReentrancyGuard {
    ...
    /**
     * @notice follows CEI
     * @param tokenCollateralAddress The address of the token to deposit as collateral. Must be WETH or WBTC
     * @param amountCollateral The amount of collateral to deposit
     */
     ...
     * @notice A known bug would be if the protocol was 100% or less collateralized, then we wouldn't be able to incentivize the liquidators.
     ...
     * @param onBehalfOf The user who is having their DSC burned
     * @param dscFrom The address that is sending the DSC to be burned
     */
